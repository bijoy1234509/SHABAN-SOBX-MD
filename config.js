...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "SHABAN-SOBX-MD~TJRgXA4A#MG80Ga-F2ARECEeghyk44kx2lDJgPKgC1yg2NN0035w",
    ...
    STATUS_REPLY: process.env.STATUS_REPLY || "`ʏᴏᴜʀ Hello ❤‍🔥ī.am Bijoy your sтαтυs sεεη נυsт ησω`",
